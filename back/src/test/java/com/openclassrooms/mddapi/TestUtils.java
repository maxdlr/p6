...
public class TestUtils {
    ...
    public static Theme makeTheme(Integer id) {
        ...
        theme
                .setId((long) id)
                .setName("theme" + id).setCreatedAt(LocalDateTime.now()).setUpdatedAt(LocalDateTime.now());
    ...
    public static ThemeDto makeThemeDto(Integer id) {
        ...
        themeDto.setId((long) id).setName("theme" + id).setCreatedAt(LocalDateTime.now()).setUpdatedAt(LocalDateTime.now());
