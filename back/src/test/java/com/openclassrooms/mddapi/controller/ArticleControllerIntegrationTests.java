...
public class ArticleControllerIntegrationTests {
    ...
    public void testCreateArticle() {
        ...
        HttpEntity<ArticleDto> themeNotFoundHttpEntity = new HttpEntity<>(articleDto, createHeadersWithToken());

        ResponseEntity<?> themeNotFoundResponse = restTemplate.postForEntity(
                baseUrl,
                themeNotFoundHttpEntity,
                String.class
        );
        ...
        HttpEntity<ArticleDto> authorNotFoundHttpEntity = new HttpEntity<>(articleDto, createHeadersWithToken());

        ResponseEntity<?> authorNotFoundResponse = restTemplate.postForEntity(
                baseUrl,
                authorNotFoundHttpEntity,
                String.class
        );
        ...
        HttpEntity<ArticleDto> badRequestHttpEntity = new HttpEntity<>(badRequestArticleDto, createHeadersWithToken());
        ResponseEntity<?> badRequestResponse = restTemplate.postForEntity(
                baseUrl,
                badRequestHttpEntity,
                String.class
        );
