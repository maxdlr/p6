create table ARTICLES (author_id bigint, created_at datetime(6), id bigint not null auto_increment, theme_id bigint, updated_at datetime(6), title varchar(50), content varchar(255), primary key (id)) engine=InnoDB;
create table COMMENTS (article_id bigint, author_id bigint, created_at datetime(6), id bigint not null auto_increment, updated_at datetime(6), content varchar(255), primary key (id)) engine=InnoDB;
